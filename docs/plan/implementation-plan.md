...
survived**, control green first and every verdict parsed off the real summary line. The two mutants
that survived the previous round (the message and the detail of `no_engine_diagnostic`) are both
killed now.
